...
inline
vec3 rotateAboutX( const vec3 &a, float radian )
{
	vec3 v;
	float c, s;
	c = cos(radian);
...
inline
vec3 rotateAboutY( const vec3 &a, float radian )
{
	vec3 v;
	float c, s;
	c = cos(radian);
...
inline
vec3 rotateAboutZ( const vec3 &a, float radian )
{
	vec3 v;
	float c, s;
	c = cos(radian);
